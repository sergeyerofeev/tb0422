...
const telegramApiKey = '2104377990:AAF_GuI-RT-pOsPAo1pBDCju1KlTUaQaqXQ';

Future<void> main() async {

  // init Telegram
  final telegram = Telegram('2104377990:AAF_GuI-RT-pOsPAo1pBDCju1KlTUaQaqXQ');
...
Future<void> downloadPhoto(
  ...
  final tFile = await teledart.getFile(tPhoto.file_id);
